...
import {Options} from '../../menuComponents/options_dialog';
...
class LevelTwo {
    ...
    setThisForCallbackFunctions() {
        ...
        this.context.drawImage(levelImages.backgroundTwo, 0, 0);
    ...
    showMenu() {
        if (this.menuOpen) {
            this.options = new Options(this.canvas);
            this.options.rendDialogWindow();
    ...
    menuRestartDraw() {
        this.options.rendRestartWindow();
    ...
    restartLevel(e) {
        ...
        this.gameEnd();
        this.context.clearRect(0, 0, 800, 600);
        let level = new LevelTwo(this.canvas);
        level.startGame();
    }
    ...
    changeVolume(e) {
        ...
        this.options.saveVolume(e.pageX - this.elemLeft);
